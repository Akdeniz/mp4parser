...
#elif true //defined(OS_POSIX) || defined(OS_FUCHSIA)
...
#define DCHECK_OP(name, op, val1, val2) EAT_STREAM_PARAMETERS
...
#if defined(ENABLE_LOG_ERROR_NOT_REACHED)
