...
#include "base/subsample_entry.h"
...
class MEDIA_EXPORT DecryptConfig {
 public:
  ...
  static std::unique_ptr<DecryptConfig> CreateCbcsConfig(
      ...
      const std::string& iv,
      const std::vector<SubsampleEntry>& subsamples,
      ::core::optional<EncryptionPattern> encryption_pattern);
  ...
  const ::core::optional<EncryptionPattern>& encryption_pattern() const {
 ...
 private:
  ...
  ::core::optional<EncryptionPattern> encryption_pattern_;
