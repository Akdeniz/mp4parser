...
#endif  // defined(ENABLE_PLATFORM_AC3_EAC3_AUDIO)
#if defined(ENABLE_PLATFORM_MPEG_H_AUDIO)
  codecs |= EME_CODEC_MPEG_H_AUDIO;
#endif  // defined(ENABLE_PLATFORM_MPEG_H_AUDIO)
...
#if defined(USE_PROPRIETARY_CODECS)
#if defined(ENABLE_MSE_MPEG2TS_STREAM_PARSER)
...
#endif  // defined(ENABLE_MSE_MPEG2TS_STREAM_PARSER)
#endif  // defined(USE_PROPRIETARY_CODECS)
