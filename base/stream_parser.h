...
#include "base/time.h"
#include "base/demuxer_stream.h"
#include "base/eme_constants.h"
...
class StreamParser {
 public:
  ...
  // @todo @akdeniz:  BufferQueueMap = std::map<TrackId, std::list<SampleBuffer>>
...
bool MergeBufferQueues(const StreamParser::BufferQueueMap& buffers,
