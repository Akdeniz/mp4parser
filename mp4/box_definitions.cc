...
#include "base/video_types.h"
//#include "media/base/video_util.h"
#include "common/opus_constants.h"
...
#include "mp4/avc.h"
#include "video/h264_parser.h"  // nogncheck

#if defined(ENABLE_PLATFORM_DOLBY_VISION)
//#include "base/optional.h"
#include "mp4/dolby_vision.h"
#endif  // defined(ENABLE_PLATFORM_DOLBY_VISION)

#if defined(ENABLE_PLATFORM_HEVC)
#include "mp4/hevc.h"
#endif  // defined(ENABLE_PLATFORM_HEVC)
...
::core::optional<DOVIDecoderConfigurationRecord> ParseDOVIConfig(
    BoxReader* reader) {
  {
...
#endif  // defined(ENABLE_AV1_DECODER)
